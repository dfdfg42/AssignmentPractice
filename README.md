...
| [backendCodingTest](backendCodingTest) | 백엔드 코딩 테스트 4문제: 카드 조합 비교, 병렬 크롤러, 채팅방 메시지 서버, 만료 지원 KV 저장소. 문제 지문은 코드에서 역추적해 재구성 | Java 17, Spring Boot | 1 | 로컬 과제 폴더 (히스토리 없음) |
